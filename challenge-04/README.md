...
*/
carro.adicionarPessoas = function(numPessoasEntram){
    if (carro.quantidadePessoas < 5) {
        if (numPessoasEntram > (carro.assentos - carro.quantidadePessoas)) {
        ...
        carro.quantidadePessoas = carro.quantidadePessoas + numPessoasEntram;

        if(carro.quantidadePessoas === carro.assentos){
            return "O carro agora está lotado!";
        };
        ...
        if(carro.quantidadePessoas > 1 && carro.quantidadePessoas <= carro.assentos){
...
// Faça o carro encher.
carro.adicionarPessoas(3);                              // 'O carro agora está lotado!'
