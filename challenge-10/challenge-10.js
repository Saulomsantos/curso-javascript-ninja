(function(){
    ...
    */
    ...
    console.log( 'O operador "+" é', isOperatorValid('+') );
    console.log( 'O operador "x" é', isOperatorValid('x') );
    ...
    */
    function calculator(operator){
        return isOperatorValid(operator) ? function(param1, param2){
            return (typeof param1 !== 'number' || typeof param2 !== 'number') ? false : operation[operator](param1, param2)
        } : false;
    };

    // Testando se uma soma de dois valores funciona
    ...
    */
    ...
    // Testando se o retorno da função é o esperado
    console.log( showOperationMessage('+', 1, 2) );     // A operação 1 + 2 =

    /*
    Crie uma função chamada "showErrorMessage" que recebe um parâmetro: o
    operador da operação de cálculo, quando a operação não for válida.
    ...
    */
    ...
    // Testando se o retorno da função é o esperado
    console.log( showErrorMessage('x') );       // Operação x não permitida!
    ...
    */
    !sum ? console.log( showErrorMessage(operationSignal) ) : 
    number1 = 4,
    number2 = 5,
    ...
    */
    ...
    invalidOperation ? (
        number1 = 1,
        number2 = 2,
        console.log( showOperationMessage(operationSignal) )) : console.log( showErrorMessage(operationSignal) );

    // Outra forma
    // !invalidOperation ? console.log( showErrorMessage(operationSignal) ) :
    // (number1 = 1, number2 = 2, console.log( showOperationMessage(operationSignal) ));
